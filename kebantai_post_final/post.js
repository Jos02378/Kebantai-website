...
document.querySelector("#form__date-selector").addEventListener("click",
  function () {
...
const form__selection__sport = document.querySelector(".form__selection__sport");
...
const optionsFormSport = form__selection__sport.querySelectorAll(".sport-radio");
...
monthSelector = new IosSelector({
  ...
  onChange: (selected) => {
    ...
    dateInput.setAttribute("placeholder", yearSelector.value + " - " + monthSelector.value + " - " + daySelector.value);
  }
});
...
let current_date_selected = document.getElementsByTagName("time")[current_date - 1];
...
const option_selected_region = document.getElementById("option_selected_region");
let region_value = "";
